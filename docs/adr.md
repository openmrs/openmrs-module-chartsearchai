...
- **−** The prompt grows. The few-shot gains one record and one demonstration, and every interaction finding carries an extra sentence: measured on the standalone, the gentamicin question went **8009 → 8309** input tokens and the 17-finding ibuprofen answer **11209 → 12254**, against a 32768-token context. About 280 of that is fixed few-shot and is therefore paid on every query, safety-related or not.
