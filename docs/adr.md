...
- [Decision 52: The ANSWER no longer decides what a substance is called, so the two safety passes stop disagreeing](#decision-52-the-answer-no-longer-decides-what-a-substance-is-called-so-the-two-safety-passes-stop-disagreeing)
...
**As of #238 (Decision 52) this section is historical: the cost below was accepted here and removed there.**
...
- **−** The question-pair arm's cross-pass residue above. **Closed by [Decision 52](#decision-52-the-answer-no-longer-decides-what-a-substance-is-called-so-the-two-safety-passes-stop-disagreeing) (issue #238):** the arm now reads its subject off a naming group the answer cannot widen, so this bullet no longer holds.
...
## Decision 52: The ANSWER no longer decides what a substance is called, so the two safety passes stop disagreeing
