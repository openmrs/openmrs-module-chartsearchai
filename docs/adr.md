...
- **−** **#315 is not fixed.** On the ticket's own chart the answer still says *"Yes — the patient was ordered Nevirapine on 2026-07-26"* about a drug stopped the day before. This decision buys a diagnosis, not a fix, and the diagnosis cost two shipped wordings' worth of review.
