...
public interface ChartSearchService {
	...
	/**
	 * Streaming variant of {@link #ask}. Calls the tokenConsumer for each token as
	 ...
	 */
	ChartAnswer askStreaming(Patient patient, String question, Consumer<String> tokenConsumer);
