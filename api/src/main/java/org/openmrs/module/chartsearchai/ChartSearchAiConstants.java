...
public class ChartSearchAiConstants {
	 ...
	 * every common ACE inhibitor and beta-blocker. Its precision over the bundled knowledge base is
	 * measured, by model adjudication rather than clinician review, in ADR Decision 111 (issue #480).
	 * {@code all} is not offered (#391 proposed it): the loader keeps no non-{@code Major}
