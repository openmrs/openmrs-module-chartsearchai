...
- **−** **The effect on citation grounding is unmeasured**, per *Measured* above. It is the one end-to-end consequence of this change nobody has put a number on.
